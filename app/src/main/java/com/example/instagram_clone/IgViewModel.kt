...
import com.example.instagram_clone.data.Event
import com.example.instagram_clone.data.PostData
import com.example.instagram_clone.data.UserData
    ...
    private fun createOrUpdateProfile(
        ...
        uid?.let{
            ...
            db.collection(USERS).document(uid).get()
                ...
                .addOnFailureListener{
                    exc -> handleException(exc, "Cannot create user")
                    inProgress.value = false
                }
        }
    }
...
//                popupNotification.value = Event("User data retrieved successfully")
            ...
            .addOnFailureListener{
                exc -> handleException(exc, "Cannot retrieve user data")
                inProgress.value = false
            }
    }
